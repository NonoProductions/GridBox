-- Benutzerrollen-System für Gridbox PWA
-- Erstellt Rollen und Policies für Owner-Zugriff

-- 1. Erstelle eine Tabelle für Benutzerrollen
...
-- 8. Aktualisiere die stations Tabelle Policies für Owner-Zugriff
...
-- 9. Erstelle Policies für user_roles Tabelle
...
-- 10. Füge einen ersten Owner hinzu (ersetzen Sie die UUID mit Ihrer eigenen)
-- WICHTIG: Ersetzen Sie 'your-user-uuid-here' mit der tatsächlichen UUID Ihres Benutzers
-- Sie finden Ihre UUID in der Supabase Auth-Tabelle oder im Dashboard
