...
export default function SideMenu({ 
  ...
  return (
    <>
      ...
      {/* Panel */}
      <aside
        className={`fixed top-0 left-0 z-[1110] h-full w-96 max-w-[90vw] ${
          isDarkMode 
      ...
      >
        ...
        <div className="py-2">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>
